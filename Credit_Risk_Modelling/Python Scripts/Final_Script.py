...
sanc_amt_L_list_AL = list()
sanc_amt_L_list_BL = list()
sanc_amt_L_list_CD = list()
sanc_amt_L_list_CV = list()
sanc_amt_L_list_GL = list()
sanc_amt_L_list_HL = list()
sanc_amt_L_list_LAS = list()
sanc_amt_L_list_MFBL = list()
sanc_amt_L_list_MFHL = list()
sanc_amt_L_list_MFOT = list()
sanc_amt_L_list_OTH = list()
sanc_amt_L_list_PL = list()
sanc_amt_L_list_PLBL = list()
sanc_amt_L_list_RL = list()
sanc_amt_L_list_SEL = list()
